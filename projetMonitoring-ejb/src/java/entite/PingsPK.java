 ...
 */
@Embeddable
public class PingsPK implements Serializable {
    ...
    public PingsPK(int idMachine, String cleTache) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PingsPK)) {
            return false;
        }
        PingsPK other = (PingsPK) object;
    ...
    public String toString() {
        return "entite.PingsPK[ idMachine=" + idMachine + ", cleTache=" + cleTache + " ]";
    }
