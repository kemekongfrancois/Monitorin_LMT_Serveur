...
public class TachePK implements Serializable {
    ...
    public TachePK(int idMachine, String cleTache) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TachePK)) {
            return false;
        }
        TachePK other = (TachePK) object;
    ...
    public String toString() {
        return "entite.TachePK[ idMachine=" + idMachine + ", cleTache=" + cleTache + " ]";
    }
