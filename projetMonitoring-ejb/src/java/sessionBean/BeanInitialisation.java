...
public class BeanInitialisation {
    ...
    public void initialisation() {
        ...
        resultat += "\ncreation de la tache verrifie date modification dernier fichier :-> " + bean.creerTacheDateModificationDernierFichier(adresse, "0 " + (i += 2) + " 12 ? * TUE-SAT", "D:/vas/web/bulk/upload/sgbcmbanking/sgbcfile", seuilDateModif, Bean.START, true, true, "SGBC", 1);
        resultat += "\ncreation de la tache verrifie date modification dernier fichier :-> " + bean.creerTacheDateModificationDernierFichier(adresse, "0 " + (i += 2) + " 12 * * ?", "D:/vas/web/bulk/upload/Tout/BGFI", seuilDateModif, Bean.START, true, true, "BGFI", 1);
        resultat += "\ncreation de la tache verrifie date modification dernier fichier :-> " + bean.creerTacheDateModificationDernierFichier(adresse, "0 " + (i += 2) + " 12 ? * TUE-SAT", "D:/vas/bicec/mBanking-Alerte/info", seuilDateModif, Bean.START, true, true, "BICEC", 1);
        resultat += "\ncreation de la tache verrifie date modification dernier fichier :-> " + bean.creerTacheDateModificationDernierFichier(adresse, "0 " + (i += 2) + " 12 ? * TUE-SAT", "D:/vas/bicec/mBanking-Balance/info", seuilDateModif, Bean.START, true, true, "BICEC", 1);
        resultat += "\ncreation de la tache verrifie date modification dernier fichier :-> " + bean.creerTacheDateModificationDernierFichier(adresse, "0 " + (i += 2) + " 12 ? * TUE-SAT", "D:/vas/bicec/mBanking-History/info", seuilDateModif, Bean.START, true, true, "BICEC", 1);
